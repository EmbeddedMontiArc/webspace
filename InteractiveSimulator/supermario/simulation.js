...
var callSVGUpdate = false;

function startSimulation() {
    FSM.TimeHandler.addEventInterval(simulationGame, 1, 10000000000);
}
...
function doSimulationStep(){
    ...
    iterationNumber++;
    if (callSVGUpdate){
        window.parent.updateSVG( window.parent.getMaxIteration());
	}
}
